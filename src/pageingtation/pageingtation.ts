export class pageingtation {
    ...
    public pageingtations(pages:number,pagestotal:number){
        ...
        if(pagestotal > 1){
          ...
          const previous={page:previous_page,name:'previous'}
          ...
          if (pages < pagestotal){ 
            ...
            const Last={page:pagestotal,name:'Last'}
            pageingtation.push(Next);
            pageingtation.push(Last);
    
          
          }else{
            const Next={page:'',name:'Next'}
            const Last={page:'',name:'Last'}
            pageingtation.push(Next);
            pageingtation.push(Last);
          }
