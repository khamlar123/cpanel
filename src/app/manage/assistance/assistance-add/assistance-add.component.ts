...
@Component({
  selector: 'app-assistance-add',
  templateUrl: './assistance-add.component.html',
  styleUrls: ['./assistance-add.component.css']
})
export class AssistanceAddComponent implements OnInit {
  modal = {
    title : '',
    fileEn : [''],
    fileLa: [''],
