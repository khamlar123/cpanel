...
@Component({
  selector: 'app-member-apply-acepted',
  templateUrl: './member-apply-acepted.component.html',
  styleUrls: ['./member-apply-acepted.component.css']
})
export class MemberApplyAceptedComponent implements OnInit {
